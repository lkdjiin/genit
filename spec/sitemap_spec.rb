...
describe Sitemap do
  ...
  it "should return a string" do
    @sitemap.build.class.should == String
  end
  
  it "should have tonly one <urlset> element" do
    doc = Nokogiri::XML::Document.parse @sitemap.build
    doc.css("urlset").size.should == 1
  end
  
  it "should have the right <urlset> element" do
    @sitemap.build.match('http://www.sitemaps.org/schemas/sitemap/0.9').should_not be_nil
  end
